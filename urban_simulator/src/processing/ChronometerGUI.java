...
//This program is another chronometer, graphics, who create the map ( Dashboard.java) and move the character as the chrono turns. Use it as base for the true chronometer. -Virginie
/**
